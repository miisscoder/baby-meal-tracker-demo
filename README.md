...
| | |
| :--- | :--- |
| ![Add a Meal Page](add-meal-screenshot.png) | **1. Log a Meal** <br>Quickly add each meal with time, date, and food items. |
| ![Daily View Page](daily-view-screenshot.png) | **2. Review Your Day** <br>See all meals for any selected day in one clear list. |
| ![Monthly Calendar Page](monthly-calendar-screenshot.png) | **3. See the Month** <br>Get a visual calendar overview of the entire month's feeding pattern. |
